...
| Frontend | `templates/` + `static/` | ✅ | HTML/JS/CSS com Bootstrap 5, servido pelo Flask |
| Infraestrutura | Docker/Compose | ✅ | `Dockerfile.backend` + `docker-compose.yml` (PostgreSQL, Redis, Celery) |
...
- [2026-09-18] (e) ← `templates/index.html` Frontend: Bootstrap 5.3, JavaScript vanilla, tema claro/escuro.
...
| Models | `backend/app/models/` | SQLAlchemy models (EmailAnalysis, User, BaseModel) | N/A |
...
| Frontend | `templates/` + `static/` | HTML/CSS/JS servido pelo Flask | N/A |
